...
public class RemoteViewsActionTest {
  ...
  private RemoteViews remoteViews;
    ...
    private TestableRemoteViewsAction createAction(int errorResId) {
        return new TestableRemoteViewsAction(picasso, null, remoteViews, 1, errorResId, false, TestUtils.URI_KEY_1, null);
    }

    private Picasso createPicasso() {
        return new Picasso(Robolectric.application,
    ...
    static class TestableRemoteViewsAction extends RemoteViewsAction {
        TestableRemoteViewsAction(
            Picasso picasso, Request data, RemoteViews remoteViews, int viewId, int errorResId, boolean skipCache, String key, String tag) {
