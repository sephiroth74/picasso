...
import it.sephiroth.android.library.picasso.NetworkRequestHandler.ContentLengthException;
...
public class DispatcherTest {
  ...
  @Test public void performSubmitWithFetchAction() {
    ...
    FetchAction fetchAction1 =
        new FetchAction(
            TestUtils.mockPicasso(), new Request.Builder(TestUtils.URI_1).build(), 0, 0, pausedTag,
            TestUtils.URI_KEY_1, null, 0);
  ...
  @Test public void performSubmitWithFetchActionWithSuccessCompletionCallback() {
    ...
    FetchAction fetchAction =
        new FetchAction(
            TestUtils.mockPicasso(), new Request.Builder(TestUtils.URI_1).build(), 0, 0, pausedTag,
            TestUtils.URI_KEY_1, callback, 0);
