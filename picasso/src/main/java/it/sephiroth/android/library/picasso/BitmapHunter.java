...
class BitmapHunter implements Runnable {
  ...
  Bitmap hunt() throws IOException {
    ...
    if (MemoryPolicy.shouldReadFromMemoryCache(memoryPolicy)) {
      if (picasso.loggingEnabled) {
        Utils.log(Utils.OWNER_HUNTER, Utils.VERB_EXECUTING, data.logId(), "cache: " + cache);
      }
    ...
    if (diskCache != null) {
      if (picasso.loggingEnabled) {
        Utils.log(Utils.OWNER_HUNTER, Utils.VERB_EXECUTING, data.logId(), "diskCache: " + diskCache);
      }
